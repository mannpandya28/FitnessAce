		...
		<div class="inner">
			...
			<!-- Login box-->
				<form name="login" method="post" action="">
                                        ...
                                        <p class="colored bold">Employee's email:</p><input type="text" name="oemail"/><br/>
					<p class="colored bold">Employee's conatct:</p><input type="text" name="ocontact"/><br/>
...
<% 
           String user_id = null, category= null;
	...
	if(cookie.getName().equals("user_id")) 
        ...
        //PreparedStatement pstmt = con.prepareStatement(sql);      
                try{
        ResultSet rs = ps.executeQuery("select * from user_detail where user_id='"+user_id+"'");
        while(rs.next())
        {
