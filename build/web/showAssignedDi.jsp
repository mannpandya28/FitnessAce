...
<body>
    <a href="Nutritionist.jsp"><h1 class="colored bold">Go back to Home</h1></a>
        ...
        ResultSet rs = ps.executeQuery("SELECT cc.id,c.name,cc.amount,c.measure,cc.time from customer_calorie_chart cc,calorie c where cc.cal_id=c.id and cc.user_id='"+uid+"'");
        %>
