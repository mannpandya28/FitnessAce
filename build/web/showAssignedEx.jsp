...
<body>
    <a href="Instructor.jsp"><h1 class="colored bold">Go back to Home</h1></a>
        ...
        ResultSet rs = ps.executeQuery("SELECT u.id,a.name,u.duration from customer_activity u,activities a where u.activity_id=a.activity_id and u.user_id='"+uid+"'");
        %>
        <table style="width:100%">
            <tr>
                <td class="colored bold"><h2>Id</h2></td>
                <td class="colored bold"><h2>Name</h2></td>
                <td class="colored bold"><h2>Duration</h2></td>
        ...
        %>
        <tr>
            <td class="colored bold"><%=rs.getString("id") %></td>
            <td class="colored bold"><%=rs.getString("name") %></td>
            <td class="colored bold"><%=rs.getString("duration") %></td>
