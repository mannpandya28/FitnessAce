...
<% 
   ...
   String id= null;
    ...
    try{
      ...
      int count = ps.executeUpdate("delete from customer_activity where user_id='"+id+"'");
      int count1 = ps.executeUpdate("delete from customer_personal_data where user_id='"+id+"'");
      int count2 = ps.executeUpdate("delete from customer_calorie_chart where user_id='"+id+"'");           
      int count3 = ps.executeUpdate("delete from user_detail where user_id='"+id+"'");
